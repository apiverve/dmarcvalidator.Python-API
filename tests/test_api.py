...
class TestDmarcvalidatorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = DmarcvalidatorAPIClient(self.api_key)

    @patch('apiverve_dmarcvalidator.apiClient.requests.get')
